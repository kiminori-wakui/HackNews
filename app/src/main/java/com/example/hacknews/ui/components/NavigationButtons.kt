...
@Composable
fun HacknewsIcon(modifier: Modifier = Modifier) {
    Image(
...
@Preview("Hacknews icon")
@Preview("Hacknews icon (dark)", uiMode = Configuration.UI_MODE_NIGHT_YES)
@Composable
fun PreviewHacknewsIcon() {
    HacknewsTheme {
        Surface {
            HacknewsIcon()
        }
